function p = carousel_parameters(cryst_output,p)
    ...
    p.Di_liq = [1e-9,1e-9,1e-9]';                  % pure component molecular diffusion coefficients [m2/s] - components 1-3
    ...
    p.coeff_antoine= [76.964, -7623.8, -7.4924, 5.9436e-18, 6,  % coefficients component 1
        74.475, -7164.3,-7.327, 3.1340e-6, 2,                   % coefficients component 2
        0, 0, 0, 0, 0];                                         % coefficients component 3
