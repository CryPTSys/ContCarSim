function [u,manipulated_vars] = controller_online(process_time,batch_time,...
    ports_working,u,u_nominal,measurements,manipulated_vars,x_estim,n_cycle,control_flag)
