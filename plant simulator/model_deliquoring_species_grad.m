function [x,y] = model_deliquoring_species_grad(cycle_time,Dt,p,u,x,y,n_batch,pos)
    ...
    if x.(['pos' num2str(pos)]).L_cake < p.min_length_discr
        ...
        final_liq_mass_fr_vect_rescaled=reshape(output(end,xx.number_nodes_deliq+1:end),...
            xx.number_nodes_deliq,p.number_components)';
%         final_liq_mass_fr_vect_rescaled=final_liq_mass_fr_vect_rescaled./sum(final_liq_mass_fr_vect_rescaled,1); % normalization (for numerical errors)
